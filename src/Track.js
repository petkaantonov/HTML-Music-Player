...
Track.prototype.matches = function(matchers) {
    return searchableTracks.trackMatches(this, matchers);
};
...
Track.prototype.stageRemoval = function() {
    ...
    if (this.tagData) {
        searchableTracks.remove(this.getUid());
    }
};

Track.prototype.unstageRemoval = function() {
    if (this.tagData) {
        searchableTracks.add(this.file, this.tagData, this);
    }
};
...
Track.prototype.setTagData = function(tagData) {
    ...
    searchableTracks.add(this.file, tagData, this);
    this.tagDataUpdated();
};
...
Track.prototype.getUid = function() {
    if (this.tagData) {
        ...
        this._uid = searchableTracks.calculateUid(this.file, this.tagData);
        return this._uid;
    } else {
