...
export default function HorizontalDragRecognizer(recognizerMaker, handler) {
...
inherits(HorizontalDragRecognizer, AbstractGestureRecognizer);

HorizontalDragRecognizer.prototype._recognizerHandler = function(e) {
