...
export default function VerticalSwipeRecognizer(recognizerMaker, handler) {
...
inherits(VerticalSwipeRecognizer, AbstractGestureRecognizer);

VerticalSwipeRecognizer.prototype._recognizerHandler = function(e) {
