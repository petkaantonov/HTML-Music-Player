import { ApplicationPreferences, SelectDeps } from "Application";
import { DomWrapperSelector } from "platform/dom/Page";
import {
    ApplicationPreferencesManager,
    maxBufferLengthValue,
    minBufferLengthValue,
} from "preferences/ApplicationPreferences";
import { SlideableValuePreferenceUiBinding, ToggleableValuePreferenceUiBinding } from "preferences/uibinders";
...
import { SlideableValue, ToggleableValue } from "ui/templates";
