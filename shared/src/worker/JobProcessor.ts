import { EventEmitterInterface, PromiseReject, PromiseResolve, UnwrapPromise } from "shared/types/helpers";
import { delay as promiseDelay } from "shared/util";
...
export default interface JobProcessor<T extends any[], R>
    extends EventEmitterInterface<{
        jobComplete: (job: Job<T, R>) => void;
        allJobsComplete: () => void;
    }> {}
