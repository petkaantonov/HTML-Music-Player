import { BufferDescriptor, ChannelData, LoadOpts } from "src/audio/AudioPlayerFrontend";
import { CodecName, FileReference, fileReferenceToTrackUid, TrackMetadata } from "src/metadata/MetadataManagerFrontend";
import FileView from "src/platform/FileView";
import CancellableOperations, { CancellationToken } from "src/utils/CancellationToken";

import AudioPlayerBackend from "./AudioPlayerBackend";
import AudioProcessingPipeline from "./AudioProcessingPipeline";
import getCodec, { Decoder } from "./codec";
import Crossfader from "./Crossfader";
import demuxer from "./demuxer";
import LoudnessAnalyzer from "./LoudnessAnalyzer";
import seeker from "./seeker";
import getCodecName from "./sniffer";
