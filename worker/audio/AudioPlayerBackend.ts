...
import Effects, { EffectSpecList } from "audio/Effects";
...
import {
    ...
    LoadOpts,
    SeekOpts,
} from "src/audio/AudioPlayerFrontend";
import { MAX_BUFFER_LENGTH_SECONDS, MIN_BUFFER_LENGTH_SECONDS } from "src/audio/buffering";
import { checkBoolean } from "src/errors/BooleanTypeError";
import { checkNumberDivisible, checkNumberRange } from "src/errors/NumberTypeError";
import Timers from "src/platform/Timers";
import { CROSSFADE_MAX_DURATION } from "src/preferences/EffectPreferences";
import { CancellationError } from "src/utils/CancellationToken";
...
> {
    ...
    constructor(wasm: WebAssemblyWrapper, timers: Timers) {
        super("audio", {
