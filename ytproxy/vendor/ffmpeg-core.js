/* eslint-disable */
// Mods: sleep lock, quit_ override
var createFFmpegCore = (function () {
    ...
    return function (createFFmpegCore) {
        ...
        var Module = {
            ...
            preRun() {
                ...
                for (const mount of global.fsMounts) {
                    FS.mkdir(mount.inmem);
                    FS.mount(NODEFS, {root: mount.root}, mount.inmem);
                }
            },
        };
        var moduleOverrides = {};
        ...
        var INITIAL_MEMORY = Module["INITIAL_MEMORY"] || 26214400;
        var wasmTable;
        var __ATPRERUN__ = [];
        var __ATINIT__ = [];
        var __ATMAIN__ = [];
        ...
        var wasmBinaryFile = "ffmpeg-core.wasm";
        ...
        var asmLibraryArg = {
            ...
            A: ___sys_getpeername,
            fa: ___sys_getrusage,
            B: ___sys_getsockname,
            x: ___sys_getsockopt,
            u: ___sys_ioctl,
            D: ___sys_listen,
            T: ___sys_lstat64,
        ...
        var _memset = (Module["_memset"] = function () {
            return (_memset = Module["_memset"] = Module["asm"]["ja"]).apply(null, arguments);
        });
        var _malloc = (Module["_malloc"] = function () {
            return (_malloc = Module["_malloc"] = Module["asm"]["ka"]).apply(null, arguments);
        });
        var ___errno_location = (Module["___errno_location"] = function () {
            return (___errno_location = Module["___errno_location"] = Module["asm"]["ma"]).apply(null, arguments);
        });
        ...
        var _htons = (Module["_htons"] = function () {
            return (_htons = Module["_htons"] = Module["asm"]["pa"]).apply(null, arguments);
        });
        var _main = (Module["_main"] = function () {
            return (_main = Module["_main"] = Module["asm"]["qa"]).apply(null, arguments);
        });
        var _htonl = (Module["_htonl"] = function () {
            return (_htonl = Module["_htonl"] = Module["asm"]["ra"]).apply(null, arguments);
        });
        ...
        var _ff_h264_cabac_tables = (Module["_ff_h264_cabac_tables"] = 1582716);
        Module["ccall"] = ccall;
        Module["cwrap"] = cwrap;
        ...
        function exit(status, implicit) {
            ...
            return quit_(status, new ExitStatus(status));
        }
        if (Module["preInit"]) {
