import TagDatabase, { stopWords, trackSearchIndexCmp } from "shared/idb/TagDatabase";
import { TrackInfo } from "shared/metadata";
import { SearchBackendActions, SearchResult, SearchWorkerResult } from "shared/search";
import { insert, merge } from "shared/sortedArrays";
...
import { getFirstWord, getLastWord, reverseString } from "shared/util";
import { normalizeQuery } from "shared/utils/searchUtil";
...
export default class SearchBackend extends AbstractBackend<SearchBackendActions<SearchBackend>, "search"> {
