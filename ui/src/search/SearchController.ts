...
import { SearchBackendActions, SearchResult, SearchResults, SearchWorkerResult } from "shared/src/search";
...
import { ALIGN_RIGHT_SIDE_AT_TOP as align } from "ui/ui/ActionMenu";
import {
    actionHandler,
...
type SFDeps = SelectDeps<"generalWorker">;
...
class SearchFrontend extends WorkerFrontend<SearchWorkerResult> {
    ...
    constructor(searchController: SearchController, deps: SFDeps) {
        super("search", deps.generalWorker);
